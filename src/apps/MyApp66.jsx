...
function CustomerView({ customer }) {
  ...
  return (
    <div>
      ...
      <Field label={"연락명"} readonly>
        <Input value={customer.contact}></Input>
      </Field>
      <Field label={"주소"} readonly>
        <Input value={customer.address}></Input>
      </Field>
      <Field label={"도시"} readonly>
        <Input value={customer.city}></Input>
      </Field>
      <Field label={"우편번호"} readonly>
        <Input value={customer.postalCode}></Input>
      </Field>
      <Field label={"국가"} readonly>
        <Input value={customer.country}></Input>
      </Field>
    </div>
  );
}
